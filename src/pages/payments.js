    ...
    <CustomLayout>
      <div className="min-h-screen bg-white">
        <section className="py-16 bg-[#F0E0ED]">
          <CustomWrapper>
            <h1 className="text-4xl md:text-5xl font-bold text-center text-[#002400]">Payment Information</h1>
        ...
        <CustomWrapper>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">
                        ...
                        and American Express. All card payments are processed securely through Paystack.
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start">
              ...
              <div className="bg-[#F0E0ED] p-8 rounded-lg">
                ...
                <ul className="space-y-4 text-gray-600">
                  <li className="flex items-start">
                    ...
                    <span>All payments are processed through Paystack's secure payment gateway</span>
                  </li>
                  <li className="flex items-start">
                    <FaShieldAlt className="text-[#002400] mt-1 mr-3" />
          ...
          <section className="py-16">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <div className="bg-white p-6 rounded-lg border border-gray-200">
                ...
                <p className="text-gray-600">
                  Once we receive your returned items, refunds are typically processed within 
                  5-7 business days.
                </p>
              </div>
            </div>
          ...
          <section className="py-16">
            <h2 className="text-3xl font-bold text-[#002400] mb-12 text-center">Frequently Asked Questions</h2>
            <div className="space-y-6">
              <div className="bg-white p-6 rounded-lg border border-gray-200">
                <div className="flex items-center mb-4">
              ...
              <div className="bg-white p-6 rounded-lg border border-gray-200">
                ...
                <p className="text-gray-600">
                  To request a refund, log into your account, go to your order history, and 
                  select the items you wish to return. Follow the prompts to initiate the refund process.
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="py-16">
            <div className="bg-[#F0E0ED] p-8 rounded-lg text-center">
              <h2 className="text-2xl font-semibold text-[#002400] mb-4">Need Help with Payments?</h2>
              <p className="text-gray-600 mb-6">
                Our customer support team is available 24/7 to assist you with any payment-related questions.
              </p>
              <a
